...
namespace ScoreTracker.WebApi.BasketballTrackers.NBATracker.Services;
...
public sealed class NBAScoreboardService : IScoreboardService<NBAScoreboardService>
{
    ...
    private const string PathSegment = "/apis/site/v2/sports/basketball/nba/scoreboard";

    public NBAScoreboardService(
